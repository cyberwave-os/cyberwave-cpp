...
public:
    ...
    utility::string_t getCredentialAuthType() const;
    bool credentialAuthTypeIsSet() const;
    void unsetCredential_auth_type();
    void setCredentialAuthType(const utility::string_t& value);

    utility::string_t getCredentialHeaderName() const;
    bool credentialHeaderNameIsSet() const;
    void unsetCredential_header_name();
    void setCredentialHeaderName(const utility::string_t& value);
...
protected:
    ...
    boost::optional<utility::string_t> m_Credential_auth_type;

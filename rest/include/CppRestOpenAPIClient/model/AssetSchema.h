...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AssetSchema_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AssetSchema_H_
...
public:
    ...
    std::map<utility::string_t, std::shared_ptr<AnyType>> getKinematics() const;
    bool kinematicsIsSet() const;
    void unsetKinematics();
    void setKinematics(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value);
...
protected:
    ...
    boost::optional<std::map<utility::string_t, std::shared_ptr<AnyType>>> m_Kinematics;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AssetSchema_H_ */

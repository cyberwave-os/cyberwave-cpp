...
class  EnvironmentWaypointSchema
    : public ModelBase
{
public:
    EnvironmentWaypointSchema();
    virtual ~EnvironmentWaypointSchema();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_EnvironmentWaypointSchema_H_ */

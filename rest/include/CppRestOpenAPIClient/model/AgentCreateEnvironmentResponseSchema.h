...
public:
    ...
    std::map<utility::string_t, std::shared_ptr<AnyType>> getAgentMetrics() const;
    bool agentMetricsIsSet() const;
    void unsetAgent_metrics();
    void setAgentMetrics(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value);
...
protected:
    ...
    std::map<utility::string_t, std::shared_ptr<AnyType>> m_Agent_metrics;
    bool m_Agent_metricsIsSet;

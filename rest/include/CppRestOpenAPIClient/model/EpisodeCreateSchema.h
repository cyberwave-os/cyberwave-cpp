...
/*
 * EpisodeCreateSchema.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_EpisodeCreateSchema_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_EpisodeCreateSchema_H_
...
class  EpisodeCreateSchema
    : public ModelBase
{
public:
    EpisodeCreateSchema();
    virtual ~EpisodeCreateSchema();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_EpisodeCreateSchema_H_ */

...
public:
    ...
    /// </summary>
    /// <remarks>
    /// Persist a one-time product tour acknowledgement for the current user.
    /// </remarks>
    /// <param name="tourId"></param>
    pplx::task<std::shared_ptr<TourCompletionSchema>> srcUsersApiProfileCompleteTour(
        utility::string_t tourId
    ) const;
    /// <summary>

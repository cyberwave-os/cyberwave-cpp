...
CloudeNodeHeartbeatResponse::CloudeNodeHeartbeatResponse()
{
    m_Success = false;
...
void CloudeNodeHeartbeatResponse::validate()
{
    // TODO: implement validation
}

web::json::value CloudeNodeHeartbeatResponse::toJson() const
{
...
bool CloudeNodeHeartbeatResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CloudeNodeHeartbeatResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CloudeNodeHeartbeatResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CloudeNodeHeartbeatResponse::isSuccess() const
{
    return m_Success;
}

void CloudeNodeHeartbeatResponse::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool CloudeNodeHeartbeatResponse::successIsSet() const
{
    return m_SuccessIsSet;
}

void CloudeNodeHeartbeatResponse::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t CloudeNodeHeartbeatResponse::getMessage() const
{
    return m_Message;
}


void CloudeNodeHeartbeatResponse::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool CloudeNodeHeartbeatResponse::messageIsSet() const
{
    return m_MessageIsSet;
}

void CloudeNodeHeartbeatResponse::unsetMessage()
{
    m_MessageIsSet = false;
}

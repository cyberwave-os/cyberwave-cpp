...
bool DatasetCreateSchema::isAllowPendingRecordings() const
{
    return m_Allow_pending_recordings.get();
}

void DatasetCreateSchema::setAllowPendingRecordings(bool value)
{
    m_Allow_pending_recordings = value;
}

bool DatasetCreateSchema::allowPendingRecordingsIsSet() const
{
    return m_Allow_pending_recordings.has_value();
}

void DatasetCreateSchema::unsetAllow_pending_recordings()
{

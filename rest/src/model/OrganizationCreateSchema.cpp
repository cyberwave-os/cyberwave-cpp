...
void OrganizationCreateSchema::validate()
{
    // TODO: implement validation
}

web::json::value OrganizationCreateSchema::toJson() const
{
...
bool OrganizationCreateSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void OrganizationCreateSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrganizationCreateSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t OrganizationCreateSchema::getName() const
{
    return m_Name;
}


void OrganizationCreateSchema::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool OrganizationCreateSchema::nameIsSet() const
{
    return m_NameIsSet;
}

void OrganizationCreateSchema::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t OrganizationCreateSchema::getSlug() const
{
    return m_Slug.get();
}


void OrganizationCreateSchema::setSlug(const utility::string_t& value)
{
    m_Slug = value;
}

bool OrganizationCreateSchema::slugIsSet() const
{
    return m_Slug.has_value();
}

void OrganizationCreateSchema::unsetSlug()
{
    m_Slug.reset();
}

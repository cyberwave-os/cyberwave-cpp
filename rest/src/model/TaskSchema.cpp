...
TaskSchema::TaskSchema()
{
    ...
    m_Default_parametersIsSet = false;
...
void TaskSchema::validate()
{
    // TODO: implement validation
}

web::json::value TaskSchema::toJson() const
{
    ...
    if(m_Default_parametersIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("default_parameters"))] = ModelBase::toJson(m_Default_parameters);
    }
...
bool TaskSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TaskSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Default_parametersIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("default_parameters")), m_Default_parameters));
    }
    if(m_Workspace_uuidIsSet)
    {
...
bool TaskSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TaskSchema::getUuid() const
{
    return m_Uuid;
}


void TaskSchema::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool TaskSchema::uuidIsSet() const
{
    return m_UuidIsSet;
}

void TaskSchema::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t TaskSchema::getName() const
{
    return m_Name;
}


void TaskSchema::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool TaskSchema::nameIsSet() const
{
    return m_NameIsSet;
}

void TaskSchema::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t TaskSchema::getDescription() const
{
    return m_Description;
}


void TaskSchema::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool TaskSchema::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void TaskSchema::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t TaskSchema::getTaskType() const
{
    return m_Task_type;
}


void TaskSchema::setTaskType(const utility::string_t& value)
{
    m_Task_type = value;
    m_Task_typeIsSet = true;
}

bool TaskSchema::taskTypeIsSet() const
{
    return m_Task_typeIsSet;
}

void TaskSchema::unsetTask_type()
{
    m_Task_typeIsSet = false;
}
utility::string_t TaskSchema::getControllerPolicyUuid() const
{
    return m_Controller_policy_uuid.get();
}


void TaskSchema::setControllerPolicyUuid(const utility::string_t& value)
{
    m_Controller_policy_uuid = value;
}

bool TaskSchema::controllerPolicyUuidIsSet() const
{
    return m_Controller_policy_uuid.has_value();
}

void TaskSchema::unsetController_policy_uuid()
{
    m_Controller_policy_uuid.reset();
}
std::map<utility::string_t, std::shared_ptr<AnyType>> TaskSchema::getDefaultParameters() const
{
    return m_Default_parameters;
}


void TaskSchema::setDefaultParameters(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Default_parameters = value;
    m_Default_parametersIsSet = true;
}

bool TaskSchema::defaultParametersIsSet() const
{
    return m_Default_parametersIsSet;
}

void TaskSchema::unsetDefault_parameters()
{
    m_Default_parametersIsSet = false;
}
utility::string_t TaskSchema::getWorkspaceUuid() const
{
    return m_Workspace_uuid;
}


void TaskSchema::setWorkspaceUuid(const utility::string_t& value)
{
    m_Workspace_uuid = value;
    m_Workspace_uuidIsSet = true;
}

bool TaskSchema::workspaceUuidIsSet() const
{
    return m_Workspace_uuidIsSet;
}

void TaskSchema::unsetWorkspace_uuid()
{
    m_Workspace_uuidIsSet = false;
}
utility::string_t TaskSchema::getVisibility() const
{
    return m_Visibility;
}


void TaskSchema::setVisibility(const utility::string_t& value)
{
    m_Visibility = value;
    m_VisibilityIsSet = true;
}

bool TaskSchema::visibilityIsSet() const
{
    return m_VisibilityIsSet;
}

void TaskSchema::unsetVisibility()
{
    m_VisibilityIsSet = false;
}
utility::datetime TaskSchema::getCreatedAt() const
{
    return m_Created_at;
}


void TaskSchema::setCreatedAt(const utility::datetime& value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}

bool TaskSchema::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void TaskSchema::unsetCreated_at()
{
    m_Created_atIsSet = false;
}
utility::datetime TaskSchema::getUpdatedAt() const
{
    return m_Updated_at;
}


void TaskSchema::setUpdatedAt(const utility::datetime& value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}

bool TaskSchema::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void TaskSchema::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}

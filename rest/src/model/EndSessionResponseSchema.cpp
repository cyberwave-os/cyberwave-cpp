...
EndSessionResponseSchema::EndSessionResponseSchema()
{
    m_Success = false;
...
void EndSessionResponseSchema::validate()
{
    // TODO: implement validation
}

web::json::value EndSessionResponseSchema::toJson() const
{
...
bool EndSessionResponseSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EndSessionResponseSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EndSessionResponseSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool EndSessionResponseSchema::isSuccess() const
{
    return m_Success;
}

void EndSessionResponseSchema::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool EndSessionResponseSchema::successIsSet() const
{
    return m_SuccessIsSet;
}

void EndSessionResponseSchema::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t EndSessionResponseSchema::getMessage() const
{
    return m_Message;
}


void EndSessionResponseSchema::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool EndSessionResponseSchema::messageIsSet() const
{
    return m_MessageIsSet;
}

void EndSessionResponseSchema::unsetMessage()
{
    m_MessageIsSet = false;
}

...
bool CloudNodeWorkloadUpdateSchema::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("simulation_ready"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("simulation_ready")));
        if(!fieldValue.is_null())
        {
            bool refVal_setSimulationReady;
            ok &= ModelBase::fromJson(fieldValue, refVal_setSimulationReady);
...
bool CloudNodeWorkloadUpdateSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("simulation_ready"))))
    {
        bool refVal_setSimulationReady;
...
bool CloudNodeWorkloadUpdateSchema::isSimulationReady() const
{
    return m_Simulation_ready.get();
}

void CloudNodeWorkloadUpdateSchema::setSimulationReady(bool value)
{
    m_Simulation_ready = value;
}

bool CloudNodeWorkloadUpdateSchema::simulationReadyIsSet() const
{
    return m_Simulation_ready.has_value();
}

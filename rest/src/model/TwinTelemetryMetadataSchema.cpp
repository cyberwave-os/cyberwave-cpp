...
TwinTelemetryMetadataSchema::TwinTelemetryMetadataSchema()
{
...
void TwinTelemetryMetadataSchema::validate()
{
    // TODO: implement validation
}

web::json::value TwinTelemetryMetadataSchema::toJson() const
{
...
bool TwinTelemetryMetadataSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TwinTelemetryMetadataSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TwinTelemetryMetadataSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TwinTelemetryMetadataSchema::getUuid() const
{
    return m_Uuid;
}


void TwinTelemetryMetadataSchema::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool TwinTelemetryMetadataSchema::uuidIsSet() const
{
    return m_UuidIsSet;
}

void TwinTelemetryMetadataSchema::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t TwinTelemetryMetadataSchema::getTwinUuid() const
{
    return m_Twin_uuid;
}


void TwinTelemetryMetadataSchema::setTwinUuid(const utility::string_t& value)
{
    m_Twin_uuid = value;
    m_Twin_uuidIsSet = true;
}

bool TwinTelemetryMetadataSchema::twinUuidIsSet() const
{
    return m_Twin_uuidIsSet;
}

void TwinTelemetryMetadataSchema::unsetTwin_uuid()
{
    m_Twin_uuidIsSet = false;
}
utility::string_t TwinTelemetryMetadataSchema::getEnvironmentUuid() const
{
    return m_Environment_uuid;
}


void TwinTelemetryMetadataSchema::setEnvironmentUuid(const utility::string_t& value)
{
    m_Environment_uuid = value;
    m_Environment_uuidIsSet = true;
}

bool TwinTelemetryMetadataSchema::environmentUuidIsSet() const
{
    return m_Environment_uuidIsSet;
}

void TwinTelemetryMetadataSchema::unsetEnvironment_uuid()
{
    m_Environment_uuidIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> TwinTelemetryMetadataSchema::getMetadata() const
{
    return m_Metadata;
}


void TwinTelemetryMetadataSchema::setMetadata(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool TwinTelemetryMetadataSchema::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void TwinTelemetryMetadataSchema::unsetMetadata()
{
    m_MetadataIsSet = false;
}

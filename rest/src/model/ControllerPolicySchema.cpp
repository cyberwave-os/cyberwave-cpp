...
utility::string_t ControllerPolicySchema::getSlug() const
{
    return m_Slug.get();
}


void ControllerPolicySchema::setSlug(const utility::string_t& value)
{
    m_Slug = value;
}

bool ControllerPolicySchema::slugIsSet() const
{
    return m_Slug.has_value();
}

void ControllerPolicySchema::unsetSlug()
{
    m_Slug.reset();
}

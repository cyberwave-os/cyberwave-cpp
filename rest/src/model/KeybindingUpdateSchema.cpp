...
KeybindingUpdateSchema::KeybindingUpdateSchema()
{
}
...
void KeybindingUpdateSchema::validate()
{
    // TODO: implement validation
}

web::json::value KeybindingUpdateSchema::toJson() const
{
...
bool KeybindingUpdateSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void KeybindingUpdateSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool KeybindingUpdateSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t KeybindingUpdateSchema::getName() const
{
    return m_Name.get();
}


void KeybindingUpdateSchema::setName(const utility::string_t& value)
{
    m_Name = value;
}

bool KeybindingUpdateSchema::nameIsSet() const
{
    return m_Name.has_value();
}

void KeybindingUpdateSchema::unsetName()
{
    m_Name.reset();
}
std::map<utility::string_t, std::shared_ptr<AnyType>> KeybindingUpdateSchema::getMetadata() const
{
    return m_Metadata.get();
}


void KeybindingUpdateSchema::setMetadata(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Metadata = value;
}

bool KeybindingUpdateSchema::metadataIsSet() const
{
    return m_Metadata.has_value();
}

void KeybindingUpdateSchema::unsetMetadata()
{
    m_Metadata.reset();
}
std::vector<std::map<utility::string_t, std::shared_ptr<AnyType>>> KeybindingUpdateSchema::getKeyboardBindings() const
{
    return m_Keyboard_bindings.get();
}


void KeybindingUpdateSchema::setKeyboardBindings(const std::vector<std::map<utility::string_t, std::shared_ptr<AnyType>>>& value)
{
    m_Keyboard_bindings = value;
}

bool KeybindingUpdateSchema::keyboardBindingsIsSet() const
{
    return m_Keyboard_bindings.has_value();
}

void KeybindingUpdateSchema::unsetKeyboard_bindings()
{

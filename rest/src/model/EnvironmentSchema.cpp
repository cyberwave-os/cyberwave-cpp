...
web::json::value EnvironmentSchema::toJson() const
{
    ...
    if(m_Has_running_simulationIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("has_running_simulation"))] = ModelBase::toJson(m_Has_running_simulation);
    }
...
bool EnvironmentSchema::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("has_running_simulation"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("has_running_simulation")));
        if(!fieldValue.is_null())
        {
            bool refVal_setHasRunningSimulation;
            ok &= ModelBase::fromJson(fieldValue, refVal_setHasRunningSimulation);
            setHasRunningSimulation(refVal_setHasRunningSimulation);
...
void EnvironmentSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Has_running_simulationIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("has_running_simulation")), m_Has_running_simulation));
    }
}
...
bool EnvironmentSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("has_running_simulation"))))
    {
        bool refVal_setHasRunningSimulation;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("has_running_simulation"))), refVal_setHasRunningSimulation );
        setHasRunningSimulation(refVal_setHasRunningSimulation);
    }
    return ok;
}
...
bool EnvironmentSchema::isHasRunningSimulation() const
{
    return m_Has_running_simulation;
}

void EnvironmentSchema::setHasRunningSimulation(bool value)
{
    m_Has_running_simulation = value;
    m_Has_running_simulationIsSet = true;
}

bool EnvironmentSchema::hasRunningSimulationIsSet() const
{
    return m_Has_running_simulationIsSet;
}

void EnvironmentSchema::unsetHas_running_simulation()
{
    m_Has_running_simulationIsSet = false;
}

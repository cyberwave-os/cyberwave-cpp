...
MarketplaceOrganizationSchema::MarketplaceOrganizationSchema()
{
...
void MarketplaceOrganizationSchema::validate()
{
    // TODO: implement validation
}

web::json::value MarketplaceOrganizationSchema::toJson() const
{
...
bool MarketplaceOrganizationSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MarketplaceOrganizationSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MarketplaceOrganizationSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MarketplaceOrganizationSchema::getUuid() const
{
    return m_Uuid;
}


void MarketplaceOrganizationSchema::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool MarketplaceOrganizationSchema::uuidIsSet() const
{
    return m_UuidIsSet;
}

void MarketplaceOrganizationSchema::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t MarketplaceOrganizationSchema::getName() const
{
    return m_Name;
}


void MarketplaceOrganizationSchema::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MarketplaceOrganizationSchema::nameIsSet() const
{
    return m_NameIsSet;
}

void MarketplaceOrganizationSchema::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MarketplaceOrganizationSchema::getSlug() const
{
    return m_Slug;
}


void MarketplaceOrganizationSchema::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool MarketplaceOrganizationSchema::slugIsSet() const
{
    return m_SlugIsSet;
}

void MarketplaceOrganizationSchema::unsetSlug()
{
    m_SlugIsSet = false;
}

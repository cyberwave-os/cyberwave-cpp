...
void RemoveMemberResponse::validate()
{
    // TODO: implement validation
}

web::json::value RemoveMemberResponse::toJson() const
{
...
bool RemoveMemberResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RemoveMemberResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RemoveMemberResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool RemoveMemberResponse::isSuccess() const
{
    return m_Success;
}

void RemoveMemberResponse::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool RemoveMemberResponse::successIsSet() const
{
    return m_SuccessIsSet;
}

void RemoveMemberResponse::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t RemoveMemberResponse::getMessage() const
{
    return m_Message;
}


void RemoveMemberResponse::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool RemoveMemberResponse::messageIsSet() const
{
    return m_MessageIsSet;
}

void RemoveMemberResponse::unsetMessage()
{
    m_MessageIsSet = false;
}

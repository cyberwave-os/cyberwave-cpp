...
EnvironmentAgentResponseSchema::EnvironmentAgentResponseSchema()
{
    ...
    m_AnswerIsSet = false;
    m_Assistant_session_id = utility::conversions::to_string_t("");
    m_Assistant_session_idIsSet = false;
...
web::json::value EnvironmentAgentResponseSchema::toJson() const
{
    ...
    if(m_Assistant_session_idIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("assistant_session_id"))] = ModelBase::toJson(m_Assistant_session_id);
    }
...
void EnvironmentAgentResponseSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Assistant_session_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("assistant_session_id")), m_Assistant_session_id));
    }
    if(m_Tool_callsIsSet)
    {
...
utility::string_t EnvironmentAgentResponseSchema::getAssistantSessionId() const
{
    return m_Assistant_session_id;
}


void EnvironmentAgentResponseSchema::setAssistantSessionId(const utility::string_t& value)
{
    m_Assistant_session_id = value;
    m_Assistant_session_idIsSet = true;
}

bool EnvironmentAgentResponseSchema::assistantSessionIdIsSet() const
{
    return m_Assistant_session_idIsSet;
}

void EnvironmentAgentResponseSchema::unsetAssistant_session_id()
{
    m_Assistant_session_idIsSet = false;
}

...
MLTrainingSchema::MLTrainingSchema()
{
...
void MLTrainingSchema::validate()
{
    // TODO: implement validation
}

web::json::value MLTrainingSchema::toJson() const
{
...
bool MLTrainingSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MLTrainingSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MLTrainingSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MLTrainingSchema::getUuid() const
{
    return m_Uuid;
}


void MLTrainingSchema::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool MLTrainingSchema::uuidIsSet() const
{
    return m_UuidIsSet;
}

void MLTrainingSchema::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t MLTrainingSchema::getDatasetUuid() const
{
    return m_Dataset_uuid;
}


void MLTrainingSchema::setDatasetUuid(const utility::string_t& value)
{
    m_Dataset_uuid = value;
    m_Dataset_uuidIsSet = true;
}

bool MLTrainingSchema::datasetUuidIsSet() const
{
    return m_Dataset_uuidIsSet;
}

void MLTrainingSchema::unsetDataset_uuid()
{
    m_Dataset_uuidIsSet = false;
}
...
void MLTrainingSchema::setCreatedByUuid(const utility::string_t& value)
{
    m_Created_by_uuid = value;
    m_Created_by_uuidIsSet = true;
}

bool MLTrainingSchema::createdByUuidIsSet() const
{
    return m_Created_by_uuidIsSet;
}

void MLTrainingSchema::unsetCreated_by_uuid()
{
    m_Created_by_uuidIsSet = false;
}
utility::string_t MLTrainingSchema::getWorkspaceUuid() const
{
    return m_Workspace_uuid;
}


void MLTrainingSchema::setWorkspaceUuid(const utility::string_t& value)
{
    m_Workspace_uuid = value;
    m_Workspace_uuidIsSet = true;
}

bool MLTrainingSchema::workspaceUuidIsSet() const
{
    return m_Workspace_uuidIsSet;
}

void MLTrainingSchema::unsetWorkspace_uuid()
{
    m_Workspace_uuidIsSet = false;
}
utility::string_t MLTrainingSchema::getStatus() const
{
    return m_Status;
}


void MLTrainingSchema::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool MLTrainingSchema::statusIsSet() const
{
    return m_StatusIsSet;
}

void MLTrainingSchema::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> MLTrainingSchema::getMetadata() const
{
    return m_Metadata;
}


void MLTrainingSchema::setMetadata(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool MLTrainingSchema::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void MLTrainingSchema::unsetMetadata()
{
    m_MetadataIsSet = false;
}
utility::datetime MLTrainingSchema::getCreatedAt() const
{
    return m_Created_at;
}


void MLTrainingSchema::setCreatedAt(const utility::datetime& value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}

bool MLTrainingSchema::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void MLTrainingSchema::unsetCreated_at()
{
    m_Created_atIsSet = false;
}
utility::datetime MLTrainingSchema::getUpdatedAt() const
{
    return m_Updated_at;
}


void MLTrainingSchema::setUpdatedAt(const utility::datetime& value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}

bool MLTrainingSchema::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void MLTrainingSchema::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}

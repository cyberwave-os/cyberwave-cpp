...
utility::string_t TwinUniversalSchemaPatchSchema::getExpectedSchemaHash() const
{
    return m_Expected_schema_hash.get();
}


void TwinUniversalSchemaPatchSchema::setExpectedSchemaHash(const utility::string_t& value)
{
    m_Expected_schema_hash = value;
}

bool TwinUniversalSchemaPatchSchema::expectedSchemaHashIsSet() const
{
    return m_Expected_schema_hash.has_value();
}

void TwinUniversalSchemaPatchSchema::unsetExpected_schema_hash()
{

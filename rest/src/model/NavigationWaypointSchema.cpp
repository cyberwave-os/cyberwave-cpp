...
web::json::value NavigationWaypointSchema::toJson() const
{
    ...
    if(m_Target_frame.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("target_frame"))] = ModelBase::toJson(m_Target_frame.get());
    }
...
bool NavigationWaypointSchema::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("target_frame"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("target_frame")));
        if(!fieldValue.is_null())
        {
            std::map<utility::string_t, std::shared_ptr<AnyType>> refVal_setTargetFrame;
            ok &= ModelBase::fromJson(fieldValue, refVal_setTargetFrame);
            setTargetFrame(refVal_setTargetFrame);
...
void NavigationWaypointSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Target_frame.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("target_frame")), m_Target_frame.get()));
    }
}
...
bool NavigationWaypointSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("target_frame"))))
    {
        std::map<utility::string_t, std::shared_ptr<AnyType>> refVal_setTargetFrame;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("target_frame"))), refVal_setTargetFrame );
        setTargetFrame(refVal_setTargetFrame);
    }
    return ok;
}
...
std::map<utility::string_t, std::shared_ptr<AnyType>> NavigationWaypointSchema::getTargetFrame() const
{
    return m_Target_frame.get();
}


void NavigationWaypointSchema::setTargetFrame(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Target_frame = value;
}

bool NavigationWaypointSchema::targetFrameIsSet() const
{
    return m_Target_frame.has_value();
}

void NavigationWaypointSchema::unsetTarget_frame()
{
    m_Target_frame.reset();
}

...
void WorkflowTemplateSchema::validate()
{
    // TODO: implement validation
}

web::json::value WorkflowTemplateSchema::toJson() const
{
    ...
    if(m_Node_countIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("node_count"))] = ModelBase::toJson(m_Node_count);
    }

    return val;
}

bool WorkflowTemplateSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("node_count"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("node_count")));
        if(!fieldValue.is_null())
        {
...
void WorkflowTemplateSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Node_countIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("node_count")), m_Node_count));
    }
}

bool WorkflowTemplateSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("node_count"))))
    {
        int32_t refVal_setNodeCount;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("node_count"))), refVal_setNodeCount );
        setNodeCount(refVal_setNodeCount);
    }
    return ok;
}
...
utility::string_t WorkflowTemplateSchema::getUuid() const
{
    return m_Uuid;
}


void WorkflowTemplateSchema::setUuid(const utility::string_t& value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}

bool WorkflowTemplateSchema::uuidIsSet() const
{
    return m_UuidIsSet;
}

void WorkflowTemplateSchema::unsetUuid()
{
    m_UuidIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getSlug() const
{
    return m_Slug;
}


void WorkflowTemplateSchema::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool WorkflowTemplateSchema::slugIsSet() const
{
    return m_SlugIsSet;
}

void WorkflowTemplateSchema::unsetSlug()
{
    m_SlugIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getName() const
{
    return m_Name;
}


void WorkflowTemplateSchema::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool WorkflowTemplateSchema::nameIsSet() const
{
    return m_NameIsSet;
}

void WorkflowTemplateSchema::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getDescription() const
{
    return m_Description;
}


void WorkflowTemplateSchema::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool WorkflowTemplateSchema::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void WorkflowTemplateSchema::unsetDescription()
{
    m_DescriptionIsSet = false;
}
bool WorkflowTemplateSchema::isIsActive() const
{
    return m_Is_active;
}

void WorkflowTemplateSchema::setIsActive(bool value)
{
    m_Is_active = value;
    m_Is_activeIsSet = true;
}

bool WorkflowTemplateSchema::isActiveIsSet() const
{
    return m_Is_activeIsSet;
}

void WorkflowTemplateSchema::unsetIs_active()
{
    m_Is_activeIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getWorkspaceUuid() const
{
    return m_Workspace_uuid;
}


void WorkflowTemplateSchema::setWorkspaceUuid(const utility::string_t& value)
{
    m_Workspace_uuid = value;
    m_Workspace_uuidIsSet = true;
}

bool WorkflowTemplateSchema::workspaceUuidIsSet() const
{
    return m_Workspace_uuidIsSet;
}

void WorkflowTemplateSchema::unsetWorkspace_uuid()
{
    m_Workspace_uuidIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getWorkspaceName() const
{
    return m_Workspace_name.get();
}


void WorkflowTemplateSchema::setWorkspaceName(const utility::string_t& value)
{
    m_Workspace_name = value;
}

bool WorkflowTemplateSchema::workspaceNameIsSet() const
{
    return m_Workspace_name.has_value();
}

void WorkflowTemplateSchema::unsetWorkspace_name()
{
    m_Workspace_name.reset();
}
utility::string_t WorkflowTemplateSchema::getEnvironmentUuid() const
{
    return m_Environment_uuid.get();
}


void WorkflowTemplateSchema::setEnvironmentUuid(const utility::string_t& value)
{
    m_Environment_uuid = value;
}

bool WorkflowTemplateSchema::environmentUuidIsSet() const
{
    return m_Environment_uuid.has_value();
}

void WorkflowTemplateSchema::unsetEnvironment_uuid()
{
    m_Environment_uuid.reset();
}
utility::string_t WorkflowTemplateSchema::getEnvironmentName() const
{
    return m_Environment_name.get();
}


void WorkflowTemplateSchema::setEnvironmentName(const utility::string_t& value)
{
    m_Environment_name = value;
}

bool WorkflowTemplateSchema::environmentNameIsSet() const
{
    return m_Environment_name.has_value();
}

void WorkflowTemplateSchema::unsetEnvironment_name()
{
    m_Environment_name.reset();
}
bool WorkflowTemplateSchema::isRunOnEdge() const
{
    return m_Run_on_edge;
}

void WorkflowTemplateSchema::setRunOnEdge(bool value)
{
    m_Run_on_edge = value;
    m_Run_on_edgeIsSet = true;
}

bool WorkflowTemplateSchema::runOnEdgeIsSet() const
{
...
void WorkflowTemplateSchema::setExecutionTarget(const utility::string_t& value)
{
    m_Execution_target = value;
    m_Execution_targetIsSet = true;
}

bool WorkflowTemplateSchema::executionTargetIsSet() const
{
    return m_Execution_targetIsSet;
}

void WorkflowTemplateSchema::unsetExecution_target()
{
    m_Execution_targetIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getVisibility() const
{
    return m_Visibility;
}


void WorkflowTemplateSchema::setVisibility(const utility::string_t& value)
{
    m_Visibility = value;
    m_VisibilityIsSet = true;
}

bool WorkflowTemplateSchema::visibilityIsSet() const
{
    return m_VisibilityIsSet;
}

void WorkflowTemplateSchema::unsetVisibility()
{
    m_VisibilityIsSet = false;
}
std::vector<utility::string_t> WorkflowTemplateSchema::getTags() const
{
    return m_Tags;
}


void WorkflowTemplateSchema::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

bool WorkflowTemplateSchema::tagsIsSet() const
{
    return m_TagsIsSet;
}

void WorkflowTemplateSchema::unsetTags()
{
    m_TagsIsSet = false;
}
bool WorkflowTemplateSchema::isIsTemplate() const
{
    return m_Is_template;
}

void WorkflowTemplateSchema::setIsTemplate(bool value)
{
    m_Is_template = value;
    m_Is_templateIsSet = true;
}

bool WorkflowTemplateSchema::isTemplateIsSet() const
{
    return m_Is_templateIsSet;
}

void WorkflowTemplateSchema::unsetIs_template()
{
    m_Is_templateIsSet = false;
}
utility::datetime WorkflowTemplateSchema::getCreatedAt() const
{
    return m_Created_at;
}


void WorkflowTemplateSchema::setCreatedAt(const utility::datetime& value)
{
    m_Created_at = value;
    m_Created_atIsSet = true;
}

bool WorkflowTemplateSchema::createdAtIsSet() const
{
    return m_Created_atIsSet;
}

void WorkflowTemplateSchema::unsetCreated_at()
{
    m_Created_atIsSet = false;
}
utility::datetime WorkflowTemplateSchema::getUpdatedAt() const
{
    return m_Updated_at;
}


void WorkflowTemplateSchema::setUpdatedAt(const utility::datetime& value)
{
    m_Updated_at = value;
    m_Updated_atIsSet = true;
}

bool WorkflowTemplateSchema::updatedAtIsSet() const
{
    return m_Updated_atIsSet;
}

void WorkflowTemplateSchema::unsetUpdated_at()
{
    m_Updated_atIsSet = false;
}
utility::string_t WorkflowTemplateSchema::getCreatedBy() const
{
    return m_Created_by.get();
}


void WorkflowTemplateSchema::setCreatedBy(const utility::string_t& value)
{
    m_Created_by = value;
}

bool WorkflowTemplateSchema::createdByIsSet() const
{
    return m_Created_by.has_value();
}

void WorkflowTemplateSchema::unsetCreated_by()
{
    m_Created_by.reset();
}
utility::string_t WorkflowTemplateSchema::getUpdatedBy() const
{
    return m_Updated_by.get();
}


void WorkflowTemplateSchema::setUpdatedBy(const utility::string_t& value)
{
    m_Updated_by = value;
}

bool WorkflowTemplateSchema::updatedByIsSet() const
{
    return m_Updated_by.has_value();
}

void WorkflowTemplateSchema::unsetUpdated_by()
{
    m_Updated_by.reset();
}
std::map<utility::string_t, std::shared_ptr<AnyType>> WorkflowTemplateSchema::getMetadata() const
{
    return m_Metadata;
}


void WorkflowTemplateSchema::setMetadata(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool WorkflowTemplateSchema::metadataIsSet() const
{
...
void WorkflowTemplateSchema::setNodes(const std::vector<std::shared_ptr<WorkflowNodeSchema>>& value)
{
    m_Nodes = value;
}

bool WorkflowTemplateSchema::nodesIsSet() const
{
    return m_Nodes.has_value();
}

void WorkflowTemplateSchema::unsetNodes()
{
    m_Nodes.reset();
}
std::vector<std::shared_ptr<WorkflowConnectionSchema>> WorkflowTemplateSchema::getConnections() const
{
    return m_Connections.get();
}


void WorkflowTemplateSchema::setConnections(const std::vector<std::shared_ptr<WorkflowConnectionSchema>>& value)
{
    m_Connections = value;
}

bool WorkflowTemplateSchema::connectionsIsSet() const
{
    return m_Connections.has_value();
}

void WorkflowTemplateSchema::unsetConnections()
{
    m_Connections.reset();
}
int32_t WorkflowTemplateSchema::getNodeCount() const
{
    return m_Node_count;
}

void WorkflowTemplateSchema::setNodeCount(int32_t value)
{
    m_Node_count = value;
    m_Node_countIsSet = true;
}

bool WorkflowTemplateSchema::nodeCountIsSet() const
{
    return m_Node_countIsSet;
}

void WorkflowTemplateSchema::unsetNode_count()
{
    m_Node_countIsSet = false;
}

...
WorkflowCreateSchema::WorkflowCreateSchema()
{
...
void WorkflowCreateSchema::validate()
{
    // TODO: implement validation
}

web::json::value WorkflowCreateSchema::toJson() const
{
...
bool WorkflowCreateSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void WorkflowCreateSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WorkflowCreateSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t WorkflowCreateSchema::getName() const
{
    return m_Name;
}


void WorkflowCreateSchema::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool WorkflowCreateSchema::nameIsSet() const
{
    return m_NameIsSet;
}
...
void WorkflowCreateSchema::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool WorkflowCreateSchema::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void WorkflowCreateSchema::unsetDescription()
{
    m_DescriptionIsSet = false;
}
bool WorkflowCreateSchema::isIsActive() const
{
    return m_Is_active;
}

void WorkflowCreateSchema::setIsActive(bool value)
{
    m_Is_active = value;
    m_Is_activeIsSet = true;
}

bool WorkflowCreateSchema::isActiveIsSet() const
{
    return m_Is_activeIsSet;
}

void WorkflowCreateSchema::unsetIs_active()
{
    m_Is_activeIsSet = false;
}
utility::string_t WorkflowCreateSchema::getWorkspaceUuid() const
{
    return m_Workspace_uuid.get();
}


void WorkflowCreateSchema::setWorkspaceUuid(const utility::string_t& value)
{
    m_Workspace_uuid = value;
}

bool WorkflowCreateSchema::workspaceUuidIsSet() const
{
    return m_Workspace_uuid.has_value();
}

void WorkflowCreateSchema::unsetWorkspace_uuid()
{
    m_Workspace_uuid.reset();
}
utility::string_t WorkflowCreateSchema::getEnvironmentUuid() const
{
    return m_Environment_uuid.get();
}


void WorkflowCreateSchema::setEnvironmentUuid(const utility::string_t& value)
{
    m_Environment_uuid = value;
}

bool WorkflowCreateSchema::environmentUuidIsSet() const
{
    return m_Environment_uuid.has_value();
}

void WorkflowCreateSchema::unsetEnvironment_uuid()
{
    m_Environment_uuid.reset();
}
bool WorkflowCreateSchema::isRunOnEdge() const
{
    return m_Run_on_edge;
}

void WorkflowCreateSchema::setRunOnEdge(bool value)
{
    m_Run_on_edge = value;
    m_Run_on_edgeIsSet = true;
}

bool WorkflowCreateSchema::runOnEdgeIsSet() const
{
    return m_Run_on_edgeIsSet;
}

void WorkflowCreateSchema::unsetRun_on_edge()
{
    m_Run_on_edgeIsSet = false;
}
utility::string_t WorkflowCreateSchema::getExecutionTarget() const
{
    return m_Execution_target.get();
}


void WorkflowCreateSchema::setExecutionTarget(const utility::string_t& value)
{
    m_Execution_target = value;
}

bool WorkflowCreateSchema::executionTargetIsSet() const
{
    return m_Execution_target.has_value();
}

void WorkflowCreateSchema::unsetExecution_target()
{
    m_Execution_target.reset();
}
utility::string_t WorkflowCreateSchema::getVisibility() const
{
    return m_Visibility;
}


void WorkflowCreateSchema::setVisibility(const utility::string_t& value)
{
    m_Visibility = value;
    m_VisibilityIsSet = true;
}

bool WorkflowCreateSchema::visibilityIsSet() const
{
    return m_VisibilityIsSet;
}

void WorkflowCreateSchema::unsetVisibility()
{
    m_VisibilityIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> WorkflowCreateSchema::getMetadata() const
{
    return m_Metadata.get();
}


void WorkflowCreateSchema::setMetadata(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Metadata = value;
}

bool WorkflowCreateSchema::metadataIsSet() const
{
    return m_Metadata.has_value();
}

void WorkflowCreateSchema::unsetMetadata()
{
    m_Metadata.reset();
}
std::vector<utility::string_t> WorkflowCreateSchema::getTags() const
{
    return m_Tags.get();
}


void WorkflowCreateSchema::setTags(const std::vector<utility::string_t>& value)
{
    m_Tags = value;
}

bool WorkflowCreateSchema::tagsIsSet() const
{
    return m_Tags.has_value();
}

void WorkflowCreateSchema::unsetTags()
{
    m_Tags.reset();
}
bool WorkflowCreateSchema::isIsTemplate() const
{
    return m_Is_template.get();
}

void WorkflowCreateSchema::setIsTemplate(bool value)
{
    m_Is_template = value;
}

bool WorkflowCreateSchema::isTemplateIsSet() const
{
    return m_Is_template.has_value();
}

void WorkflowCreateSchema::unsetIs_template()
{
    m_Is_template.reset();
}

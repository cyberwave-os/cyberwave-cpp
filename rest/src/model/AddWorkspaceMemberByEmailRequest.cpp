...
AddWorkspaceMemberByEmailRequest::AddWorkspaceMemberByEmailRequest()
{
...
void AddWorkspaceMemberByEmailRequest::validate()
{
    // TODO: implement validation
}

web::json::value AddWorkspaceMemberByEmailRequest::toJson() const
{
...
bool AddWorkspaceMemberByEmailRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AddWorkspaceMemberByEmailRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddWorkspaceMemberByEmailRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AddWorkspaceMemberByEmailRequest::getEmail() const
{
    return m_Email;
}


void AddWorkspaceMemberByEmailRequest::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool AddWorkspaceMemberByEmailRequest::emailIsSet() const
{
    return m_EmailIsSet;
}

void AddWorkspaceMemberByEmailRequest::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t AddWorkspaceMemberByEmailRequest::getRole() const
{
    return m_Role;
}


void AddWorkspaceMemberByEmailRequest::setRole(const utility::string_t& value)
{
    m_Role = value;
    m_RoleIsSet = true;
}

bool AddWorkspaceMemberByEmailRequest::roleIsSet() const
{
    return m_RoleIsSet;
}

void AddWorkspaceMemberByEmailRequest::unsetRole()
{
    m_RoleIsSet = false;
}
